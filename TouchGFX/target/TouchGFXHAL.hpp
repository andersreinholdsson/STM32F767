 ...
 * @sa HAL
 */
#define LCD_Exti EXTI0_IRQn
#define CTP_Exti EXTI1_IRQn
#define RTP_Exti EXTI3_IRQn

class TouchGFXHAL : public TouchGFXGeneratedHAL
{
public:
	EXTI_HandleTypeDef   hExti_LCD;
	EXTI_HandleTypeDef   hExti_CTP;
	EXTI_HandleTypeDef   hExti_RTP;
     ...
     */
    virtual bool copyFrameBufferBlockToLCD(const touchgfx::Rect& dest);
    virtual bool blockCopy(void* RESTRICT dest, const void* RESTRICT src, uint32_t numBytes);
    static void flipScreen(uint8_t bInvert);
